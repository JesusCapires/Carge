        ...
        <div class="header-content-left">
            ...
            <div class="header-element">
                <div class="horizontal-logo">
                    <a href="{{route('dashq')}}"  class="header-logo">
                ...
                <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    <div class="p-3">
                        <div class="d-flex align-items-center justify-content-between">
                            <p class="mb-0 fs-17 fw-semibold">Notificationes</p>
                            <span class="badge bg-secondary-transparent" id="notifiation-data">5 Sin leer</span>
                        </div>
                    </div>
                    ...
                    <div class="p-5 empty-item1 d-none">
                        <div class="text-center">
                            ...
                            <h6 class="fw-semibold mt-3">Ahora no existen notificationes</h6>
                        </div>
                    </div>
                </div>
