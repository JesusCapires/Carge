...
<body>
    ...
    <div class="modal fade" id="modalBase" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalBase" aria-hidden="true">
        <div class="modal-dialog modal-xl" id="modalTamano">
    ...
    <!-- HRM Dashboard JS -->
    <script src="{{ asset('js/hrm-dashboard.js') }}"></script>
    ...
    <script src="{{ asset('js/catalogs/modals.js') }}"></script>
